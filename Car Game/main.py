...
# Creating a class that handles the movement of both cars(Players and computers) - Base class for the PlayerCar and ComputerCar classes
class AbstractCar:
...
# Creating a child class of AbstractCar class that inherits its methods
...
# Defining functin that moves the car by pressing the keyboard
...
# Move forward when "a" key is pressed
    if keys[pygame.K_w]:
        moved = True
